...
#define IRQAGENT0_VALUE \
  0x0000 /* Remote Management Unit, only PCI INTA, routed to PIRQA   */
#define IRQAGENT1_VALUE \
  0x3210 /* PCIe* Multi-function, PCI INTA-D, routed to PIRQA-D resp */
#define IRQAGENT2_VALUE \
  0x0001 /* Reserved						    */
#define IRQAGENT3_VALUE \
  0x7654 /* IO Fabric Multi-func, PCI INTA-D, routed to PIRQE-H resp */

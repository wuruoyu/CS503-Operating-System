...
volatile struct lapic_csreg *lapic = (struct lapic_csreg *)LAPIC_BASE_ADDR;
 ...
 *------------------------------------------------------------------------
 */
int set_ivec(uint32 inum,   /* Interrupt number	*/
 ...
 *------------------------------------------------------------------------
 */
int32 ioapic_irq2vec(int32 irq, int32 vec) {
 ...
 *------------------------------------------------------------------------
 */
void int_dispatch(int32 inum,   /* Interrupt number	*/
